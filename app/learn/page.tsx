      ...
      <div className="flex flex-col gap-3">
        {modalities.map((m) => (
          m.available ? (
            ...
            <div
              key={m.title}
              className="flex items-center gap-4 rounded-2xl border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.04)] px-6 py-5 opacity-50"
            >
              <div className="flex flex-1 flex-col gap-1.5 min-w-0">
                <div className="flex items-center gap-2.5">
                  <span className="text-base font-bold text-white">{m.title}</span>
                  <span className="rounded-full border border-[rgba(255,255,255,0.15)] px-2.5 py-0.5 text-xs font-semibold text-[rgba(255,255,255,0.4)]">
                    {m.badge}
                  </span>
                </div>
                <p className="text-sm text-[rgba(255,255,255,0.4)]">{m.description}</p>
              </div>
            </div>
          )
        ))}
